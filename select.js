    ...
    return new Promise((resolve, reject) => {
        ...
        inq.prompt([{
            ...
            inq.prompt([{
                ...
                name: 'website',
                validate: () => pathValidator(answers.website, 'Website')
            }]).then((answers) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        inq.prompt([{
            ...
            inq.prompt([{
                ...
                name: 'campaign',
                validate: () => pathValidator(answers.campaign, 'Campaign')
            }]).then((answers) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        inq.prompt([{
            ...
            inq.prompt([{
                ...
                name: 'variation',
                validate: () => pathValidator(answers.variation, 'Variation')
            }]).then((answers) => {
    ...
    fs.readdirSync(rootPath).forEach(website => {
        fs.readdirSync(path.join(rootPath, website)).forEach(campaign => {
            fs.readdirSync(path.join(rootPath, website, campaign)).forEach(variation => {
                ...
                fs.unlinkSync(path.join(rootPath, website, campaign, variation, '.now'));
            });
        });
    });
